...
% $Id: doc.tex,v 1.1 2005-06-27 08:57:55 jatoivol Exp $
...
abstraction. The lowest level of computation is done with so-called
potentials and therefore the files providing the abstract data type (ADT) 
{\it potential} is used throughout the system.
