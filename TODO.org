...
- ANSI C + GNU Bison? C99 and POSIX.1-2001?
- Define _POSIX_C_SOURCE in config.h or nip.h?
...
- baklava code :: a set of too thin layers, or 
...
* TODO Document the code structure
