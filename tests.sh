...
of=test/output5.txt
ef=test/expect5.txt
parallel echo "Correct={}, Reordered={}" ::: 0.4 0.5 0.5 0.6 0.6 0.5 0.5 0.4 0.2 0.4 0.6 0.7 0.8 0.6 0.4 0.3 0.1 0.3 0.6 0.9 0.9 0.7 0.4 0.1 > $ef
echo "Marginalisation returned 0. (0 is OK)" >> $ef
echo "Normalised probability of A:" >> $ef
echo "result[0] = 0.49225" >> $ef
echo "result[1] = 0.2973"  >> $ef
echo "result[2] = 0.21045" >> $ef
