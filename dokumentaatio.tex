...
% $Id: dokumentaatio.tex,v 1.38 2004-11-29 15:59:55 jatoivol Exp $
...
array is the least significant one and $\mathbf{X} = \{X_1,X_2\}$, then 
\begin{itemize}
...
distribution of all the variables in the original belief network, which is
called the \textbf{global consistency}:
\begin{equation}
...
\subsubsection{Maintaining the consistency}
