...
% $Id: dokumentaatio.tex,v 1.14 2004-09-01 11:23:32 jatoivol Exp $
...
parsing are defined in the \verb+parser.h+ file. There's also a file
named \verb+fileio.c+ which contains functions for tokenising the
...
function which starts the Hugin net file parser for reading a model
from a file.
\begin{description}
...
\verb+parser.c+ to open the net file prior to parsing, to close it
...
Most of the actions executed by the net file parser is done by the
