...
% $Id: dokumentaatio.tex,v 1.22 2004-09-20 06:44:37 jatoivol Exp $
...
The Graph data type is implemented via an adjacency graph. The
...
The data type {\it Graph} defined in \verb+Graph.h+ is a struct which
...
and it is stored in the variable \textbf{size}. The matrix is
implemented as a simple array. For this reason it is manipulated via
the macro \textbf{ADJM}.
