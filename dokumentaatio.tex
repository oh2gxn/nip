...
% $Id: dokumentaatio.tex,v 1.6 2004-08-23 14:03:24 jatoivol Exp $
...
so-called flat index into the integer array \textbf{indices} according 
...
\verb+p->size_of_data - 1+ inclusive.

\item[general\_marginalise(source, destination, source\_vars)] 

\item[total\_marginalise(source, destination, variable)] 
